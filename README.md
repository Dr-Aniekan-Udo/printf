## printf()
The printf project is a collaboration between Aniekan Udo and Ibrahim Olayode, students of Software Engineering at ALX/Holberton School, were a function named "_printf" imitates the actual "printf" command located in the stdio.h library. It contains some of the basic features and functions found in the manual 3 of "printf".
